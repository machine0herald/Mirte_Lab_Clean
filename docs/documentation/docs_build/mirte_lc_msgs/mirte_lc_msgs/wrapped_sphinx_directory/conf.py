...
exec(open("/workspaces/lcr/src/mirte_lc/docs_build/mirte_lc_msgs/mirte_lc_msgs/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mirte_lc_msgs")
ensure_global('author', """florian""")
