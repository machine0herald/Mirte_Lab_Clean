...
exec(open("/workspaces/lcr/src/mirte_lc/docs_build/mirte_lc_nav2/mirte_lc_nav2/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mirte_lc_nav2")
ensure_global('author', """your_name""")
