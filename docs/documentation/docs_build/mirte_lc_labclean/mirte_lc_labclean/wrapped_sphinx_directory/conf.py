...
exec(open("/workspaces/lcr/src/mirte_lc/docs_build/mirte_lc_labclean/mirte_lc_labclean/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mirte_lc_labclean")
