...
exec(open("/workspaces/lcr/src/mirte_lc/docs_build/mirte_lc_moveit_cpp/mirte_lc_moveit_cpp/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mirte_lc_moveit_cpp")
ensure_global('author', """matth""")
