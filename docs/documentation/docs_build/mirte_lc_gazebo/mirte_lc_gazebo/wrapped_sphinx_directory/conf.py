...
exec(open("/workspaces/lcr/src/mirte_lc/docs_build/mirte_lc_gazebo/mirte_lc_gazebo/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mirte_lc_gazebo")
