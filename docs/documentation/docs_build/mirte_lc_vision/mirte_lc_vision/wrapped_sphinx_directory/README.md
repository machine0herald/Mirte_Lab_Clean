...
- Path: `/workspaces/lcr/src/mirte_lc/docs/documentation/docs_build/mirte_lc_vision/mirte_lc_vision/wrapped_sphinx_directory`

## Quickstart
1. Source your workspace: `source /opt/ros/<distro>/setup.bash && source install/setup.bash`
2. Build (if needed): `colcon build --packages-select mirte_lc_vision`
